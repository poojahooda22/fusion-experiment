...
export const RECIPES = [
  {
    ...
    weight: 16,
    swatch: 'accent',
    uniforms: { u_roughness: 0.05, u_specular: 1.5, u_reflectivity: 1.0, u_metalness: 0.0 },
  },
  {
    id: 'accentAltGloss',
    weight: 7,
    swatch: 'accentAlt',
    uniforms: { u_roughness: 0.08, u_specular: 1.3, u_reflectivity: 0.95, u_metalness: 0.0 },
  },
  {
    id: 'accentMatte',
    weight: 8,
    swatch: 'accent',
    uniforms: { u_roughness: 0.46, u_specular: 0.3, u_reflectivity: 0.62, u_metalness: 0.0 },
  },
  {
    id: 'blackGloss',
    weight: 8,
    swatch: 'black',
    uniforms: { u_roughness: 0.04, u_specular: 1.6, u_reflectivity: 1.0, u_metalness: 0.1 },
  },
  {
    id: 'blackRubber',
    weight: 10,
    swatch: 'charcoal',
    uniforms: { u_roughness: 0.58, u_specular: 0.18, u_reflectivity: 0.5, u_metalness: 0.0 },
  },
  {
    id: 'lightMatte',
    weight: 20,
    swatch: 'grey',
    uniforms: { u_roughness: 0.4, u_specular: 0.38, u_reflectivity: 0.68, u_metalness: 0.0 },
  },
  {
    id: 'lightGloss',
    weight: 11,
    swatch: 'white',
    uniforms: { u_roughness: 0.07, u_specular: 1.35, u_reflectivity: 0.9, u_metalness: 0.0 },
  },
  {
    id: 'frosted',
    weight: 5,
